...
class Agent(models.Model):
    ...
    telegram_nick = models.CharField(max_length=30, unique=True, verbose_name='Telegram Nick')
    telegram_id = models.IntegerField(default=0, unique=True, verbose_name='Telegram ID')
